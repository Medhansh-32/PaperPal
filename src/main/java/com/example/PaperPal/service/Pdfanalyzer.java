...
public class Pdfanalyzer {
    ...
    @Async
    public void analyzePdf(UserResponse userResponse, String fileType,String userName,byte[] fileBytes,String fileName) throws IOException {
        ...
        ResponseEntity<HashMap<String, Object>> response = webClient
                .post()
                .uri(url)
                ...
                try {
                    if (fileUploadable) {
                        ...
                        if (userResponseService.getExamLinkByUserResponse(userResponse) == null) {
                            userResponseService.saveUserResponse(userResponse, fileBytes, fileType,fileName);
                        } else {
                            userResponseService.addFileToUser(userResponse, fileBytes, fileType,fileName);
                        }
